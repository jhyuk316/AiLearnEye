...
public class LiteracyService {
    ...
    public GetMoreSentenceResponse getMoreSentence(long literacyId) {
        ...
        GetMoreSentenceResponse getMoreSentenceResponse = new GetMoreSentenceResponse("title", "In our modern world, it is essential to find economical and natural solutions to problems and, in doing so, commiserate with a succinct understanding of the challenges we face.", "현대 세상에서는 문제에 대한 경제적이고 자연스러운 해결책을 찾는 것이 중요하며, 이를 통해 우리는 간결한 이해와 함께 그 문제에 공감합니다.");
        try {
